...
mkdir sthv2
azcopy_linux_amd64_10.16.0/azcopy copy 'https://wu2train.blob.core.windows.net/datasets/sthv2/videos/'${SAS} sthv2/ --recursive
azcopy_linux_amd64_10.16.0/azcopy copy 'https://wu2train.blob.core.windows.net/datasets/sthv2/train.csv'${SAS} sthv2/
azcopy_linux_amd64_10.16.0/azcopy copy 'https://wu2train.blob.core.windows.net/datasets/sthv2/test.csv'${SAS} sthv2/


DATA_PATH=sthv2/
TRAIN_LIST=sthv2/train.csv
VAL_LIST=sthv2/test.csv
